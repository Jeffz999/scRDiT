...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        :param input_size: gene size of each sample.
        :param patch_size: input_size must be an integer divisible by patch_size.
        :param hidden_size: length of each token.
        :param depth: num of DiT blocks.
        :param num_heads: head number of multi-head attention.
        """
        super().__init__()
...
if __name__ == '__main__':
    # model test
    t = torch.Tensor([i for i in range(16)])
